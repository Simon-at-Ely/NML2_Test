...
Components:
    ...
    null (Type: include)
    null (Type: include)
    network_AOB_MC_Single_Channel_Tests_copy (Type: networkWithTemperature:  temperature=308.15 (SI temperature))
    sim1 (Type: Simulation:  length=60.0 (SI time) step=2.5E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt):
        ...
        # Adding simulation Component(id=sim1 type=Simulation) of network/component: network_AOB_MC_Single_Channel_Tests_copy (Type: networkWithTemperature:  temperature=308.15 (SI temperature))
        ...
        h("{ a_CellGroup_0[0].position(104.920364, 18.725296, 37.0781) }")
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=60000.0, dt=0.025)
