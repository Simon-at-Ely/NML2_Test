COMMENT
   ...
   **************************************************
   ...
   /channelml/channel_type/current_voltage_relation/gate[2]/time_course/@expr = 4 
   ...
   /channelml/channel_type/current_voltage_relation/gate[2]/steady_state/@expr = v &lt; 0 ? 0 : ((-0.006*v) + 0.40) 
...
// File from which this was generated: /home/Simon/NML2_Test/iAMC_Fig10H2T/AOB_MC_neuroConstruct/cellMechanisms/Kdr_iAMC_ChannelML/KChannel.xml

// XSL file with mapping to simulator: /home/Simon/NML2_Test/iAMC_Fig10H2T/AOB_MC_neuroConstruct/cellMechanisms/Kdr_iAMC_ChannelML/ChannelML_v1.8.1_NEURONmod.xsl
...
, temp_adj_n
 ...
 DEPEND celsius FROM -100 TO 100 WITH 400
    ...
    ? Found a generic form of the rate equation for tau, using expression: 4
    tau = 4
        
    ntau = tau/temp_adj_n
     
    ? Found a generic form of the rate equation for inf, using expression: v < 0 ? 0 : ((-0.006*v) + 0.40)
